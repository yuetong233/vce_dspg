...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("Home",
             ...
             p("The goal is to understand how volunteer capacity aligns with 4-H program ",
               
               "participation and to identify demographic gaps or outreach opportunities."),
             ...
             tags$ol(
               ...
               tags$li(strong("Volunteer County Data:"), " view distribution of volunteers."),
               
               tags$li(strong("Participation County Data:"), " explore program reach."),
               
               tags$li(strong("Volunteers vs Participation:"), " compare volunteer supply versus demand."),
               
               tags$li(strong("Demographic Data:"), " examine participant demographics.")
             ...
             p("Developed by Your Name, Virginia Cooperative Extension, ",
               
               "with support from the Department of Agricultural and Applied Economics, ",
...
server <- function(input, output, session) {
  ...
  # --- NEW COLOR SCALE: change every 100% ----------------
