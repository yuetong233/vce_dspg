...
ui <- fluidPage(
  ...
  tabsetPanel(id = "tabs",
              tabPanel("Home",
                       h2("Welcome"),
                       p("This dashboard was developed by Diego Cuadra and Jeffrey Ogle"),
